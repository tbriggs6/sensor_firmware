/** \mainpage Driver Overview
  ...
  * Studio tool:
  * - <b>Project name</b>:     Water Sensor
  * - <b>Project file</b>:     C:/Users/tbriggs/Documents/Texas Instruments/Sensor Controller Studio/projects/water.scp
  * - <b>Code prefix</b>:      SCS
  ...
  * - <b>Created</b>:          2018-12-05 16:02:05.869
  ...
  * Code for reading from the water sensor.
  *
  *
...
/// ReadData: Length of calibration data
#define SCIF_SCS_READ_DATA_CALLENGTH 7
...
/// ReadData: Conductivity samples
#define SCIF_SCS_READ_DATA_CONDUCT_SAMPS 16
...
/// ReadData: 
#define SCIF_SCS_READ_DATA_GAIN16X 2
/// ReadData: Giving the color sensor a gain of 4
#define SCIF_SCS_READ_DATA_GAIN4X 1
/// ReadData: Number of hall samples to use for filtering.
#define SCIF_SCS_READ_DATA_HALL_SAMPS 16
...
/// ReadData: 
#define SCIF_SCS_READ_DATA_MS5637_ADC_LEN 3
/// ReadData: I2C bus address
#define SCIF_SCS_READ_DATA_MS5637_ADDR 118
/// ReadData: Read D1, 256 times over-sampling
#define SCIF_SCS_READ_DATA_MS5637_CMD_D1_256 64
/// ReadData: Convert D2
#define SCIF_SCS_READ_DATA_MS5637_CMD_D2_256 80
/// ReadData: Read prom base command
#define SCIF_SCS_READ_DATA_MS5637_CMD_PROM 160
/// ReadData: Read ADC value
#define SCIF_SCS_READ_DATA_MS5637_CMD_RDADC 0
/// ReadData: Reset command
#define SCIF_SCS_READ_DATA_MS5637_CMD_RESET 30
/// ReadData: 16-bit words for PROM 
#define SCIF_SCS_READ_DATA_MS5637_PROM_LEN 7
/// ReadData: The number of 1ms Delays needed for Power on
#define SCIF_SCS_READ_DATA_POW_DELAY 5
/// ReadData: 
#define SCIF_SCS_READ_DATA_PRESS_LEN 3
/// ReadData: Repeated byte protocol transaction
#define SCIF_SCS_READ_DATA_RPT 0
/// ReadData: 
#define SCIF_SCS_READ_DATA_TEMP_SAMPS 16
...
typedef struct {
    ...
    uint16_t Conductivity[16];      ///< The conductivity of the water
    uint16_t HallSensor[16];        ///< The hall sensor value
    uint16_t TemperatureSensor[16]; ///< The water temp value
    ...
    uint16_t ms5637cal[7];          ///< calibration data
    uint16_t ms5637press[3];        ///< MS5637 pressure measurement
    uint16_t ms5637temp[3];         ///< temperature
...
typedef struct {
    ...
    uint16_t press;     ///< pressure upper 16
    uint16_t temp;      ///< temp upper-16
