...
//    	IntMasterEnable();
//
////	uint8_t *ptr = (uint8_t *) &flash_config;
////	uint8_t *dptr = (uint8_t *) &config;
//
////	printf("Checking address: %p to %p\n", &config, &flash_config);
////
...
//		config.magic = CONFIG_MAGIC;
//		config.bcast_interval = 10;
//		config.sensor_interval = 15;
//
//		config_write( );
//		config_read();
//	}
