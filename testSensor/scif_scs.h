/** \mainpage Driver Overview
  ...
  * - <b>Project file</b>:     Z:/Senior_Research_Devaun/firmware/SensorControllerCode/AnalogPlus/AnalogPlus.scp
  * - <b>Code prefix</b>:      SCS
  ...
  * - <b>Created</b>:          2018-02-28 14:20:34.763
  * - <b>Computer</b>:         MCT163S10
  * - <b>User</b>:             mp6024
  *
  ...
  *     - <b>XD: Analog peripherals power rail</b>: DIO7
  *
  *
...
#define SCIF_SCS_ANALOG_SENSOR_NUM_ANALOG_INP 5
/// AnalogSensor I/O mapping: Analog Input
#define SCIF_SCS_ANALOG_SENSOR_DIO_AANA_INPUT { 23, 24, 25, 26, 27 }
/// AnalogSensor I/O mapping: Analog peripherals power rail
#define SCIF_SCS_ANALOG_SENSOR_DIO_XD_ANA_POWER 7
...
typedef struct {
    uint16_t anaValues[5]; ///< Analog input values
